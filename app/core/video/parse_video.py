"""
Video parsing utilities.

Migrated from src/core/parse_video.py to provide clean separation
...
def image_with_most_non_black_space(images, output_path=None, return_type="path"):
    ...
    if image_with_max_non_black_space is not None and output_path:
