"""
Video planner core logic.

Migrated from src/core/video_planner.py to provide clean separation
...
class EnhancedVideoPlanner:
    ...
    async def _generate_scene_implementation_single_enhanced(self, topic: str, description: str, 
        ...
        # Create a simple implementation plan for now
        implementation_plan = f"""# Scene {scene_number} Implementation Plan

## Vision Storyboard
{scene_outline_i}

## Technical Implementation
This scene will be implemented using Manim animations.

## Animation Narration
Narration will be generated for this scene.
"""
        ...
        try:
            await self._async_file_write(combined_plan_path, implementation_plan)
    ...
    def _extract_scene_outline_robust(self, response_text: str) -> str:
        ...
        if incomplete_match:
            ...
            return f"<SCENE_OUTLINE>{xml_content}</SCENE_OUTLINE>"
