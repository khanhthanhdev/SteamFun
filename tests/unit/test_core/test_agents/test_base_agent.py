...
class TestBaseAgent:
    ...
    async def test_execute_with_monitoring_success(self, concrete_agent, mock_state):
        ...
        with patch('app.core.agents.base_agent.get_langfuse_service') as mock_langfuse:
    ...
    def test_get_model_wrapper_openrouter(self, concrete_agent, mock_state):
        ...
        with patch('app.core.agents.base_agent.OpenRouterWrapper') as mock_wrapper:
            mock_instance = Mock()
    ...
    def test_get_model_wrapper_litellm(self, concrete_agent, mock_state):
        ...
        with patch('app.core.agents.base_agent.LiteLLMWrapper') as mock_wrapper:
            mock_instance = Mock()
            mock_wrapper.return_value = mock_instance
    ...
    def test_create_human_intervention_command(self, concrete_agent, mock_state):
        ...
        with patch('app.core.agents.base_agent.request_human_approval') as mock_request:
    ...
    def test_log_agent_action(self, concrete_agent):
        ...
        with patch('app.core.agents.base_agent.logger') as mock_logger:
...
class TestAgentFactory:
    ...
    def test_create_planner_agent(self, mock_config, mock_system_config):
        ...
        with patch('app.core.agents.base_agent.PlannerAgent') as mock_agent_class:
            mock_instance = Mock()
    ...
    def test_create_code_generator_agent(self, mock_config, mock_system_config):
        ...
        with patch('app.core.agents.base_agent.CodeGeneratorAgent') as mock_agent_class:
            mock_instance = Mock()
            mock_agent_class.return_value = mock_instance
    ...
    def test_create_all_agent_types(self, mock_config, mock_system_config):
        ...
        for agent_type in expected_agents:
            with patch(f'app.core.agents.base_agent.{agent_type.title().replace("_", "")}') as mock_class:
                mock_instance = Mock()
