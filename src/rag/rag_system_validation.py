...
class RAGSystemValidator:
    ...
    def _mock_enhanced_components(self, rag):
        """Mock enhanced components to simulate full functionality."""
        from src.rag.query_generation import EnhancedQuery, QueryIntent, ComplexityLevel
        from src.rag.result_types import RankedResult, ResultType, ResultMetadata, ChunkData
